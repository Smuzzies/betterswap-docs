        ...
        <html lang="en">
            <body className={`${fontRethink.variable} antialiased`}>
                <div className="relative flex min-h-dvh flex-col">
                    {/* Header */}
                    <header className="sticky top-0 z-50 border-b border-white/5 bg-background backdrop-blur-xl">
                        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 lg:px-8">
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <span className="rounded-full bg-white/5 px-2 py-0.5 text-xs text-white/50">Docs</span>
                                </a>
                            </div>
                            <a
